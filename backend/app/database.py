    ...
    if settings.supabase_url and settings.supabase_service_role_key:
        ...
        class ChallengeAuth:
            def get_user(self, token):
                # - removed static "mock-token-123" (instant admin) and a decode with verify_signature=False
                # - any forged token naming a mock admin was accepted; signed tokens are verified in core/auth.py
