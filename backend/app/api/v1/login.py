...
async def login(request: LoginRequest):
    ...
    try:
        ...
        # - this path issued a token for any listed email without checking the password
        # - no password store exists here, so fail closed; cost: only the two client accounts can log in
        raise HTTPException(
